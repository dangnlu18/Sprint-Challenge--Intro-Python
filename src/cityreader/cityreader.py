...
latlon1 = [float(inp) for inp in l1.split(',')]
latlon2 = [float(inp) for inp in l2.split(',')]


def cityreader_stretch(lat1=latlon1[0], lon1=latlon1[1], lat2=latlon2[0], lon2=latlon2[0], cities=[]):
